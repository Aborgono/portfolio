...
function Contact() {
    ...
    return (
        <div className="contact-container">
            <h1> Let's Connect! </h1>
            <div>
                <p>I'm looking to collaborate on innovative software projects that tackle real-world challenges and push the boundaries of what's possible.</p>
                <div>
                    <a href=""> Here's my email </a>
                    <a href=""> Downlaod my resume </a>
                    <div> Socials
